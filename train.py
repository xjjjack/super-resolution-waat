...
def train(epoch):
    ...
    for iteration, (lr_tensor, hr_tensor) in enumerate(tqdm(training_data_loader), 1):
...
def save_checkpoint(epoch):
    model_folder = r"G:\ECE1508\project\ESRT\checkpoint\x3_1".format(args.scale)
    model_out_path = os.path.join(model_folder, "epoch_{}.pth".format(epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--root", type=str, default=r"F:\DIV2k_modify",#"/data0/luzs/dataset/",
    ...
    testset = Set5_val.DatasetFromFolderVal(r"G:\ECE1508\project\ESRT\set5\HR",
                                        r"G:\ECE1508\project\ESRT\set5\LR".format(args.scale),
                                        args.scale)
